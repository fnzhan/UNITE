...
parser.add_argument('--annotation_file', type=str, default="/data/vdd/fangneng.zfn/datasets/COCO-Stuff/annotations/instances_train2017.json",
...
parser.add_argument('--input_label_dir', type=str, default="/data/vdd/fangneng.zfn/datasets/COCO-Stuff/train2017_label/train2017/",
...
parser.add_argument('--output_instance_dir', type=str, default="/data/vdd/fangneng.zfn/datasets/COCO-Stuff/train2017_inst/",
